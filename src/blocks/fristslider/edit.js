...
//crop
    ...
    function onChangeTextPostion  (TextPostion) {
        setAttributes({ TextPostion });
    };
...
function apply() {
			...
			<InspectorControls>
				<PanelBody title={ __( 'Image settings' ) }>
					...
					/>
                            ...
                            <SelectControl
                                label={__("Image Size", "epicslider-blocks")}
				...
				<PanelBody>   
							<RangeControl
                                label={__("Left To Right", "themename-blocks")}
                                value={TextPostion}
                                onChange={onChangeTextPostion}
                                min={10}
                                max={70}
                                step={10}
                            />
	...
	return (
		<>
		<div className={"slide__img"} id={"image-wrapper"} key={ key }>
		{visibleOnOverlay &&  (
