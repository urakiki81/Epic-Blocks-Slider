...
var GalleryEdit = /*#__PURE__*/function (_Component) {
  ...
  (0, _createClass2.default)(GalleryEdit, [{
    ...
    value: function onSelectImages(newImages) {
      ...
      this.setAttributes({
        images: newImages.map(function (newImage) {
          return _objectSpread({}, (0, _shared.pickRelevantMediaFiles)(newImage, sizeSlug), {
    ...
    value: function setImageAttributes(index, attributes) {
      ...
      setAttributes({
        images: [].concat((0, _toConsumableArray2.default)(images.slice(0, index)), [_objectSpread({}, images[index], {}, attributes)], (0, _toConsumableArray2.default)(images.slice(index + 1)))
      });
    }
  }, {
    ...
    value: function updateImagesSize(sizeSlug) {
      ...
      var updatedImages = (0, _lodash.map)(images, function (image) {
        ...
        return _objectSpread({}, image, {}, url && {
          url: url
        });
      });
      this.setAttributes({
  ...
  if (isSelected) {
    resizedImages = (0, _lodash.reduce)(ids, function (currentResizedImages, id) {
      ...
      var sizes = (0, _lodash.reduce)(imageSizes, function (currentSizes, size) {
        ...
        return _objectSpread({}, currentSizes, (0, _defineProperty2.default)({}, size.slug, defaultUrl || mediaDetailsUrl));
      }, {});
      return _objectSpread({}, currentResizedImages, (0, _defineProperty2.default)({}, parseInt(id, 10), sizes));
    }, {});
  }
