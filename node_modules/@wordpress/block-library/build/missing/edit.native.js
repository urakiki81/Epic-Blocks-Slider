...
var UnsupportedBlockEdit = /*#__PURE__*/function (_Component) {
  ...
  (0, _createClass2.default)(UnsupportedBlockEdit, [{
    ...
    value: function renderSheet(blockTitle, blockName) {
      ...
      }, isUnsupportedBlockEditorSupported ? (0, _i18n.__)("We are working hard to add more blocks with each release. In the meantime, you can also edit this block using your device's web browser.") : (0, _i18n.__)('We are working hard to add more blocks with each release. In the meantime, you can also edit this post on the web.'))), isUnsupportedBlockEditorSupported && (0, _element.createElement)(_element.Fragment, null, (0, _element.createElement)(_components.BottomSheet.Cell, {
