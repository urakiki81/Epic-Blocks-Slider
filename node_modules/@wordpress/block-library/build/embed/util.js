...
exports.getAttributesFromPreview = exports.createUpgradedEmbedBlock = exports.getPhotoHtml = exports.isFromWordPress = exports.findMoreSuitableBlock = exports.matchesPatterns = exports.getEmbedInfoByProvider = void 0;
...
function getClassNames(html) {
  ...
  if (!allowResponsive) {
    ...
    _constants.ASPECT_RATIOS.forEach(function (_ref4) {
  ...
  if (iframe && iframe.height && iframe.width) {
    ...
    for (var ratioIndex = 0; ratioIndex < _constants.ASPECT_RATIOS.length; ratioIndex++) {
      ...
      if (aspectRatio >= potentialRatio.ratio) {
        return (0, _dedupe.default)(existingClassNames, potentialRatio.className, 'wp-has-aspect-ratio');
      }
    }
  }
