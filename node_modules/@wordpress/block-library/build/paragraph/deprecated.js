...
var migrateCustomColorsAndFontSizes = function migrateCustomColorsAndFontSizes(attributes) {
  ...
  return _objectSpread({}, (0, _lodash.omit)(attributes, ['customTextColor', 'customBackgroundColor', 'customFontSize']), {
    style: style
  });
};
...
var deprecated = [{
  supports: supports,
  attributes: _objectSpread({}, (0, _lodash.omit)(blockAttributes, ['style']), {
    customTextColor: {
      type: 'string'
    },
  ...
  supports: supports,
  attributes: (0, _lodash.omit)(_objectSpread({}, blockAttributes, {
    fontSize: {
      type: 'number'
    }
  }), ['style']),
  ...
  migrate: function migrate(attributes) {
    return migrateCustomColorsAndFontSizes((0, _lodash.omit)(_objectSpread({}, attributes, {
