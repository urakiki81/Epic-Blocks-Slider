...
import { BlockContextProvider, InnerBlocks, BlockPreview, __experimentalBlock as Block } from '@wordpress/block-editor';
/**
...
export default function QueryLoopEdit(_ref) {
  ...
  return createElement(Block.div, null, blockContexts && blockContexts.map(function (blockContext) {
