...
var migrateCustomColorsAndFontSizes = function migrateCustomColorsAndFontSizes(attributes) {
  ...
  return _objectSpread({}, omit(attributes, ['customTextColor', 'customBackgroundColor', 'customFontSize']), {
    style: style
  });
};
...
var deprecated = [{
  supports: supports,
  attributes: _objectSpread({}, omit(blockAttributes, ['style']), {
    customTextColor: {
      type: 'string'
    },
  ...
  migrate: function migrate(attributes) {
    return migrateCustomColorsAndFontSizes(omit(_objectSpread({}, attributes, {
