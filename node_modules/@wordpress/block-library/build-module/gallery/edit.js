    ...
    value: function onSelectImages(newImages) {
      ...
      this.setAttributes({
        images: newImages.map(function (newImage) {
          return _objectSpread({}, pickRelevantMediaFiles(newImage, sizeSlug), {
  ...
  if (isSelected) {
    resizedImages = reduce(ids, function (currentResizedImages, id) {
      ...
      var sizes = reduce(imageSizes, function (currentSizes, size) {
        ...
        return _objectSpread({}, currentSizes, _defineProperty({}, size.slug, defaultUrl || mediaDetailsUrl));
      }, {});
      return _objectSpread({}, currentResizedImages, _defineProperty({}, parseInt(id, 10), sizes));
    }, {});
  }
