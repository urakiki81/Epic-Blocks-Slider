...
var migrateCustomColorsAndGradients = function migrateCustomColorsAndGradients(attributes) {
  ...
  return _objectSpread({}, omit(attributes, ['customTextColor', 'customBackgroundColor', 'customGradient']), {
    style: style
  });
};

var oldColorsMigration = function oldColorsMigration(attributes) {
  return migrateCustomColorsAndGradients(omit(_objectSpread({}, attributes, {
