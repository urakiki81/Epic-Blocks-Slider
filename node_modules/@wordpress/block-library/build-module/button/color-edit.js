...
import { getColorObjectByColorValue, getColorObjectByAttributeValues, getGradientValueBySlug, getGradientSlugByValue, __experimentalPanelColorGradientSettings as PanelColorGradientSettings, ContrastChecker, InspectorControls } from '@wordpress/block-editor';
var isWebPlatform = Platform.OS === 'web'; // The code in this file is copied entirely from the "color" and "style" support flags
