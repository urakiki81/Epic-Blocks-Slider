...
export var UnsupportedBlockEdit = /*#__PURE__*/function (_Component) {
  ...
  _createClass(UnsupportedBlockEdit, [{
    ...
    value: function renderSheet(blockTitle, blockName) {
      ...
      }, isUnsupportedBlockEditorSupported ? __("We are working hard to add more blocks with each release. In the meantime, you can also edit this block using your device's web browser.") : __('We are working hard to add more blocks with each release. In the meantime, you can also edit this post on the web.'))), isUnsupportedBlockEditorSupported && createElement(Fragment, null, createElement(BottomSheet.Cell, {
