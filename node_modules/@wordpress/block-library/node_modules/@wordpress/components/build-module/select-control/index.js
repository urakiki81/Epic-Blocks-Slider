...
function SelectControl(_ref, ref) {
  var className = _ref.className,
      ...
      props = _objectWithoutProperties(_ref, ["className", "disabled", "help", "hideLabelFromVision", "id", "isFloatingLabel", "label", "multiple", "onBlur", "onChange", "onFocus", "options", "size", "value", "labelPosition"]);
