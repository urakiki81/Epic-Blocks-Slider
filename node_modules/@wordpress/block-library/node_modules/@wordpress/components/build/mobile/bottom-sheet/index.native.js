  ...
  (0, _createClass2.default)(BottomSheet, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          isChildrenScrollable = _this$props.isChildrenScrollable,
          ...
          rest = (0, _objectWithoutProperties2.default)(_this$props, ["title", "isVisible", "leftButton", "rightButton", "hideHeader", "style", "contentStyle", "getStylesFromColorScheme", "onDismiss", "isChildrenScrollable", "children", "withHeaderSeparator"]);
      ...
      var listProps = {
        ...
        contentContainerStyle: [_styles.default.content, hideHeader && _styles.default.emptyHeader, contentStyle, isChildrenScrollable && this.getContentStyle(), contentStyle],
      ...
      var WrapperView = isChildrenScrollable ? _reactNative.View : _reactNative.ScrollView;
      ...
      return (0, _element.createElement)(_reactNativeModal.default, (0, _extends2.default)({
      ...
      }), !hideHeader && getHeader(), (0, _element.createElement)(WrapperView, isChildrenScrollable ? {
        ...
        accessible: false
      }, (0, _element.createElement)(_element.Fragment, null, children))), !isChildrenScrollable && (0, _element.createElement)(_reactNative.View, {
        style: {
