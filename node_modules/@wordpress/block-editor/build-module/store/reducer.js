      ...
      case 'UPDATE_BLOCK_ATTRIBUTES':
        {
          ...
          var next = action.clientIds.reduce(function (accumulator, id) {
            return _objectSpread({}, accumulator, _defineProperty({}, id, reduce(action.attributes, function (result, value, key) {
      ...
      case 'MOVE_BLOCKS_TO_POSITION':
        {
          ...
          if (fromRootClientId === toRootClientId) {
            ...
            return _objectSpread({}, state, _defineProperty({}, toRootClientId, moveTo(state[toRootClientId], fromIndex, _index, clientIds.length)));
          } // Moving from a parent block to another


          return _objectSpread({}, state, (_objectSpread7 = {}, _defineProperty(_objectSpread7, fromRootClientId, without.apply(void 0, [state[fromRootClientId]].concat(_toConsumableArray(clientIds)))), _defineProperty(_objectSpread7, toRootClientId, insertAt(state[toRootClientId], clientIds, _index)), _objectSpread7));
        }
      ...
      case 'MOVE_BLOCKS_UP':
        {
          ...
          return _objectSpread({}, state, _defineProperty({}, _rootClientId, moveTo(_subState2, firstIndex, firstIndex - 1, _clientIds.length)));
        }
      ...
      case 'MOVE_BLOCKS_DOWN':
        {
          ...
          return _objectSpread({}, state, _defineProperty({}, _rootClientId2, moveTo(_subState3, _firstIndex, _firstIndex + 1, _clientIds2.length)));
        }
  ...
  switch (action.type) {
    ...
    case 'UPDATE_BLOCK_ATTRIBUTES':
      return action.clientIds.reduce(function (accumulator, id) {
        return _objectSpread({}, accumulator, _defineProperty({}, id, action.attributes));
      }, {});
  }
