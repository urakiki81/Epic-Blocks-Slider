...
var PanelColorGradientSettingsSelect = function PanelColorGradientSettingsSelect(props) {
  var colorGradientSettings = useSelect(function (select) {
  ...
  colorGradientSettings.disableCustomGradients = !useEditorFeature('gradient.custom');
  return createElement(PanelColorGradientSettingsInner, _objectSpread({}, colorGradientSettings, {}, props));
};
