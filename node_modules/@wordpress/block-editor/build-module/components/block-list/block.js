...
function BlockListBlock(_ref) {
  ...
  if (!isValid) {
    block = createElement(Block.div, null, createElement(BlockInvalidWarning, {
      clientId: clientId
    ...
    }, blockEdit), createElement(Block.div, {
    ...
    block = createElement(Block.div, wrapperProps, blockEdit);
  }
  ...
  }, block), !!hasError && createElement(Block.div, null, createElement(BlockCrashWarning, null)));
}
