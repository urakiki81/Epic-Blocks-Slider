...
var _default = {
  MERGE_BLOCKS: function MERGE_BLOCKS(action, store) {
    ...
    var blockA = (0, _selectors.getBlock)(state, clientIdA);
    ...
    var blockB = (0, _selectors.getBlock)(state, clientIdB);
    var blockBType = (0, _blocks.getBlockType)(blockB.name);

    var _getSelectionStart = (0, _selectors.getSelectionStart)(state),
    ...
    if (canRestoreTextSelection) {
      ...
      dispatch((0, _actions.selectionChange)(blockA.clientId, newAttributeKey, newOffset, newOffset));
    }

    dispatch((0, _actions.replaceBlocks)([blockA.clientId, blockB.clientId], [_objectSpread({}, blockA, {
