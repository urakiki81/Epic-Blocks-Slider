...
var PanelColorGradientSettingsSelect = function PanelColorGradientSettingsSelect(props) {
  ...
  colorGradientSettings.disableCustomGradients = !(0, _useEditorFeature.default)('gradient.custom');
  return (0, _element.createElement)(PanelColorGradientSettingsInner, _objectSpread({}, colorGradientSettings, {}, props));
};
