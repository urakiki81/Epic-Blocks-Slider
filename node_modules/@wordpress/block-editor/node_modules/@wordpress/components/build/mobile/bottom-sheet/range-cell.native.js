...
var BottomSheetRangeCell = /*#__PURE__*/function (_Component) {
  ...
  (0, _createClass2.default)(BottomSheetRangeCell, [{
    ...
    value: function toFixed(num) {
      var _this$props$toFixed = this.props.toFixed,
          toFixed = _this$props$toFixed === void 0 ? 0 : _this$props$toFixed;
      var fixed = Math.pow(10, toFixed);
    ...
    value: function validateInput(text) {
      ...
      return Math.min(Math.max(this.removeNonDigit(text), minimumValue), maximumValue);
    }
  }, {
    key: "removeNonDigit",
    value: function removeNonDigit(text) {
      var toFixed = this.props.toFixed;
      var regex = toFixed > 0 ? /^(\d+\.?(\d+)?)/ : /^([\d]+)/;
    ...
    value: function onChangeText(textValue) {
      var inputValue = this.removeNonDigit(textValue);
