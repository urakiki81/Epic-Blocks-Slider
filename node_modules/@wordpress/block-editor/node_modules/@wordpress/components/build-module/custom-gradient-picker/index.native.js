...
function CustomGradientPicker(_ref) {
  ...
  var _getGradientParsed = getGradientParsed(currentColor),
  ...
  function getGradientColor(type) {
    ...
    return serializeGradient(isLinearGradient(type) ? _objectSpread({}, gradientAST, {}, gradientAST.orientation ? {} : {
      orientation: gradientOrientation
    }, {
      type: type
    }) : _objectSpread({}, omit(gradientAST, ['orientation']), {
      type: type
    }));
  }
  ...
  function setGradientAngle(value) {
    var gradientColor = serializeGradient(_objectSpread({}, gradientAST, {
      orientation: {
        type: 'angular',
        value: value
      }
