...
var Draggable = /*#__PURE__*/function (_Component) {
  ...
  function Draggable() {
    ...
    _this.dragComponentRef = createRef();
    return _this;
  }
  ...
  _createClass(Draggable, [{
    ...
    value: function onDragOver(event) {
      ...
      var _this$props$onDragOve = this.props.onDragOver,
          onDragOver = _this$props$onDragOve === void 0 ? noop : _this$props$onDragOve; // The `event` from `onDragOver` is not a SyntheticEvent
    ...
    value: function onDragStart(event) {
      ...
      if (this.dragComponentRef.current) {
        ...
        this.cloneWrapper.style.top = "".concat(event.clientY, "px");
