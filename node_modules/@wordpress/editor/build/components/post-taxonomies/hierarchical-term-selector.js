  ...
  (0, _createClass2.default)(HierarchicalTermSelector, [{
    ...
    value: function onAddTerm(event) {
      ...
      findOrCreatePromise.then(function (term) {
        ...
        var termAddedMessage = (0, _i18n.sprintf)(
        /* translators: %s: taxonomy name */
        (0, _i18n._x)('%s added', 'term'), (0, _lodash.get)(_this2.props.taxonomy, ['labels', 'singular_name'], slug === 'category' ? (0, _i18n.__)('Category') : (0, _i18n.__)('Term')));
