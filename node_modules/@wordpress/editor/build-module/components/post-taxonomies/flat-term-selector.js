 ...
 */
import { escape as escapeString, find, get, invoke, isEmpty, map, throttle, unescape as lodashUnescapeString, uniqBy } from 'lodash';
/**
...
var FlatTermSelector = /*#__PURE__*/function (_Component) {
  _inherits(FlatTermSelector, _Component);

  var _super = _createSuper(FlatTermSelector);
  ...
  _createClass(FlatTermSelector, [{
    ...
    value: function render() {
      ...
      var termAddedLabel = sprintf(
      /* translators: %s: term name. */
      _x('%s added', 'term'), singularName);
      var termRemovedLabel = sprintf(
      /* translators: %s: term name. */
      _x('%s removed', 'term'), singularName);
      var removeTermLabel = sprintf(
      /* translators: %s: term name. */
