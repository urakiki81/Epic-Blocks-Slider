  ...
  data: function data() {
    ...
    switch (action.type) {
      case 'RECEIVE_REUSABLE_BLOCKS':
        {
          return _objectSpread({}, state, {}, keyBy(action.results, 'id'));
        }
      ...
      case 'UPDATE_REUSABLE_BLOCK':
        {
          ...
          return _objectSpread({}, state, _defineProperty({}, id, _objectSpread({}, state[id], {}, changes)));
        }
      ...
      case 'SAVE_REUSABLE_BLOCK_SUCCESS':
        {
          ...
          var value = state[_id];
          return _objectSpread({}, omit(state, _id), _defineProperty({}, updatedId, _objectSpread({}, value, {
            id: updatedId
          })));
        }
