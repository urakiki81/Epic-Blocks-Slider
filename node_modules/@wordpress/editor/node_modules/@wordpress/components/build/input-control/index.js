...
function InputControl(_ref, ref) {
  var _ref$__unstableStateR = _ref.__unstableStateReducer,
    ...
    return state;
      ...
      suffix = _ref.suffix,
      value = _ref.value,
      props = (0, _objectWithoutProperties2.default)(_ref, ["__unstableStateReducer", "className", "disabled", "hideLabelFromVision", "id", "isPressEnterToChange", "isFloatingLabel", "label", "labelPosition", "onBlur", "onChange", "onFocus", "onValidate", "onKeyDown", "prefix", "size", "suffix", "value"]);
