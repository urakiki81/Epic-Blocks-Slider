...
function (_Component) {
  ...
  function Popover() {
    ...
    _this.getAnchorRect = _this.getAnchorRect.bind((0, _assertThisInitialized2.default)(_this));
    _this.computePopoverPosition = _this.computePopoverPosition.bind((0, _assertThisInitialized2.default)(_this));
    _this.maybeClose = _this.maybeClose.bind((0, _assertThisInitialized2.default)(_this));
    _this.throttledRefresh = _this.throttledRefresh.bind((0, _assertThisInitialized2.default)(_this));
    _this.refresh = _this.refresh.bind((0, _assertThisInitialized2.default)(_this));
    _this.refreshOnAnchorMove = _this.refreshOnAnchorMove.bind((0, _assertThisInitialized2.default)(_this));
  ...
  (0, _createClass2.default)(Popover, [{
    ...
    value: function render() {
      ...
      var _this$props4 = this.props,
          ...
          anchorRect = _this$props4.anchorRect,
          contentProps = (0, _objectWithoutProperties2.default)(_this$props4, ["headerTitle", "onClose", "children", "className", "onClickOutside", "noArrow", "position", "range", "focusOnMount", "getAnchorRect", "expandOnMobile", "animate", "anchorRect"]);
