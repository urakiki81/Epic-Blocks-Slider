...
export declare const useMenuItemRadio: {
    (options?: MenuItemRadioOptions | undefined, htmlProps?: import("..").InputHTMLProps | undefined, unstable_ignoreUseOptions?: boolean | undefined): import("..").InputHTMLProps;
    unstable_propsAreEqual: (prev: import("..").BoxOptions & {
        ...
        id?: string | undefined;
    } & Pick<Partial<import("..").CompositeStateReturn>, "baseId" | "unstable_virtual" | "orientation" | "unstable_moves" | "unstable_hasActiveWidget"> & Pick<import("..").CompositeStateReturn, "down" | "up" | "next" | "first" | "last" | "currentId" | "items" | "registerItem" | "unregisterItem" | "previous" | "setCurrentId"> & Pick<Partial<import("..").RadioStateReturn>, "state" | "setState"> & {
        value: string | number;
        checked?: boolean | undefined;
        unstable_checkOnFocus?: boolean | undefined;
    } & Pick<Partial<MenuStateReturn>, "hide" | "visible" | "placement" | "unstable_popoverStyles" | "unstable_arrowStyles"> & Pick<MenuStateReturn, "next" | "move" | "previous"> & Pick<MenuStateReturn, "unstable_values" | "unstable_setValue"> & {
        /**
         * MenuItemRadio's name as in `menu.values`.
         */
        name: string;
    ...
    __keys: readonly any[];
    __useOptions: (options: MenuItemRadioOptions, htmlProps: import("..").InputHTMLProps) => MenuItemRadioOptions;
};
