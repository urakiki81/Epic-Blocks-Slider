...
export declare const useToolbarItem: {
    ...
    unstable_propsAreEqual: (prev: import("..").BoxOptions & {
        ...
        id?: string | undefined;
    } & Pick<Partial<import("..").CompositeStateReturn>, "baseId" | "unstable_virtual" | "orientation" | "unstable_moves" | "unstable_hasActiveWidget"> & Pick<import("..").CompositeStateReturn, "down" | "up" | "next" | "first" | "last" | "currentId" | "items" | "registerItem" | "unregisterItem" | "previous" | "setCurrentId"> & import("react").HTMLAttributes<any> & import("react").RefAttributes<any> & {
...
export declare const ToolbarItem: import("reakit-system/src/createComponent").Component<"button", CompositeItemOptions>;
