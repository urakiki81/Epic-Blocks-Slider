...
export declare const useToolbar: {
    ...
    } & Pick<Partial<import("..").CompositeStateReturn>, "wrap" | "baseId" | "currentId" | "unstable_virtual" | "orientation" | "groups" | "unstable_moves"> & Pick<import("..").CompositeStateReturn, "move" | "first" | "last" | "items" | "setCurrentId"> & Pick<Partial<ToolbarStateReturn>, "orientation"> & import("react").HTMLAttributes<any> & import("react").RefAttributes<any> & {
