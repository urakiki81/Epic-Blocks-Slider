...
export declare const useCompositeItem: {
    ...
    unstable_propsAreEqual: (prev: import("..").BoxOptions & {
        ...
        id?: string | undefined;
    } & Pick<Partial<CompositeStateReturn>, "baseId" | "unstable_virtual" | "orientation" | "unstable_moves" | "unstable_hasActiveWidget"> & Pick<CompositeStateReturn, "down" | "up" | "next" | "first" | "last" | "currentId" | "items" | "registerItem" | "unregisterItem" | "previous" | "setCurrentId"> & React.HTMLAttributes<any> & React.RefAttributes<any> & {
...
export declare const CompositeItem: import("reakit-system/src/createComponent").Component<"button", CompositeItemOptions>;
