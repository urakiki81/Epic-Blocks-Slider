...
function useTabState(initialState) {
  ...
  var composite = CompositeState.useCompositeState(_rollupPluginBabelHelpers._objectSpread2({
    loop: loop,
    currentId: initialSelectedId
  }, sealed));
  var panels = CompositeState.useCompositeState();
...
var keys = [].concat(CompositeState.useCompositeState.__keys, ["selectedId", "panels", "manual", "select", "setSelectedId", "registerPanel", "unregisterPanel"]);
