...
function reducer(state, action) {
  ...
  switch (action.type) {
    ...
    case "unregisterItem":
      {
        ...
        if (currentId && currentId === _id2) {
          var nextId = getCurrentId(_rollupPluginBabelHelpers._objectSpread2(_rollupPluginBabelHelpers._objectSpread2({}, _nextState), {}, {
    ...
    case "setCurrentId":
      {
        var nextCurrentId = getCurrentId(_rollupPluginBabelHelpers._objectSpread2(_rollupPluginBabelHelpers._objectSpread2({}, state), {}, {
    ...
    case "reset":
      return _rollupPluginBabelHelpers._objectSpread2(_rollupPluginBabelHelpers._objectSpread2({}, state), {}, {
        ...
        currentId: getCurrentId(_rollupPluginBabelHelpers._objectSpread2(_rollupPluginBabelHelpers._objectSpread2({}, state), {}, {
...
function useCompositeState(initialState) {
  ...
  var _React$useReducer = React.useReducer(reducer, {
    ...
    initialWrap: wrap
      ...
      state = _rollupPluginBabelHelpers._objectWithoutPropertiesLoose(_React$useReducer$, ["pastIds", "initialVirtual", "initialRTL", "initialOrientation", "initialCurrentId", "initialLoop", "initialWrap", "hasSetCurrentId"]),
  ...
  var idState = IdState.unstable_useIdState(sealed); // register/unregister may be called when this component is unmounted. We
